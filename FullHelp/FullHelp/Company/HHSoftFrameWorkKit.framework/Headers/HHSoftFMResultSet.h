...
@interface HHSoftFMResultSet : NSObject {
    HHSoftFMDatabase          *_parentDB;
    HHSoftFMStatement         *_statement;
...
@property (atomic, retain) HHSoftFMStatement *statement;
...
+ (instancetype)resultSetWithStatement:(HHSoftFMStatement *)statement usingParentDatabase:(HHSoftFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(HHSoftFMDatabase *)newDb;
