...
typedef NS_ENUM(NSInteger, HHSoftSDImageCacheType) {
    /**
...
typedef void(^SDWebImageQueryCompletedBlock)(UIImage *image, HHSoftSDImageCacheType cacheType);
 ...
 */
@interface HHSoftSDImageCache : NSObject
 ...
 */
+ (HHSoftSDImageCache *)sharedImageCache;
