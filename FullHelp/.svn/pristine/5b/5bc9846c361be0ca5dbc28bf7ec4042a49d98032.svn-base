...
@interface HHSoftFMDatabase : NSObject  {
...
- (HHSoftFMResultSet *)executeQuery:(NSString*)sql, ...;
...
- (HHSoftFMResultSet *)executeQueryWithFormat:(NSString*)format, ... NS_FORMAT_FUNCTION(1,2);
...
- (HHSoftFMResultSet *)executeQuery:(NSString *)sql withArgumentsInArray:(NSArray *)arguments;
...
- (HHSoftFMResultSet *)executeQuery:(NSString *)sql withParameterDictionary:(NSDictionary *)arguments;


// Documentation forthcoming.
- (HHSoftFMResultSet *)executeQuery:(NSString*)sql withVAList: (va_list)args;
...
@interface HHSoftFMStatement : NSObject {
