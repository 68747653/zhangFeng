//
//  HHSoftImageScrollCollectionViewFlowLayout.m
//  FullHelp
//
...
@interface HHSoftImageScrollCollectionViewFlowLayout ()
...
@implementation HHSoftImageScrollCollectionViewFlowLayout
...
-(NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect{
    ...
    for (UICollectionViewLayoutAttributes *attribute in attributes) {
        ...
        if (self.type == HHSoftScaleLayout) {
            [att addObject:[self scaleWithAttribute:attribute]];
        }else if(self.type == HHSoftRotationLayout1) {
            [att addObject:[self rotation1WithAttribute:attribute]];
        }else if(self.type == HHSoftRotationLayout2) {
