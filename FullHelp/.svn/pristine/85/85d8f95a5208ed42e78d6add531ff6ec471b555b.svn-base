//
//  AttentionNoticeViewController.m
//  FullHelp
//
...
@interface AttentionNoticeViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@property (nonatomic,copy) AttentionNoticeCanEditBlock canEditBlock;
@property (nonatomic,copy) AttentionNoticeIsAllDeleteBlock isAllDeleteBlock;
@property (nonatomic,strong) UIView *bottomView;
@property (nonatomic,assign) BOOL isAllSelect;

@end

@implementation AttentionNoticeViewController
...
-(UIView *)bottomView{
    if (_bottomView == nil) {
        ...
        chooseButton.tag = 744;
        [_bottomView addSubview:chooseButton];
        [chooseButton addTarget:self action:@selector(allChooseNoticeButtonClick:) forControlEvents:UIControlEventTouchUpInside];
        //删除
        ...
        [deleteButton addTarget:self action:@selector(deleteNoticeButtonClick) forControlEvents:UIControlEventTouchUpInside];
    }
    //全选、取消全选
    UIButton *chooseButton = (UIButton *)[_bottomView viewWithTag:744];
...
-(void)allChooseNoticeButtonClick:(UIButton *)button{
