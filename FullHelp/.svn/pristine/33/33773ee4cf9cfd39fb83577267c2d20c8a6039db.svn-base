//
//  MerchantsRewardOngoingViewController.m
//  FullHelp
//
...
@interface MerchantsRewardOngoingViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MerchantsRewardOngoingViewController
