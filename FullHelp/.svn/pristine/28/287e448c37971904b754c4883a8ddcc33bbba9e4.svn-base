//
//  MerchantsRewardRefusedViewController.m
//  FullHelp
//
...
@interface MerchantsRewardRefusedViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MerchantsRewardRefusedViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //原因
    cell.reasonSupplierRewardBlock = ^(){
        RewardInfo *rewardInfo = _arrData[indexPath.row];
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"拒绝原因" message:[NSString stringByReplaceNullString:rewardInfo.rewardNoPassReason] preferredStyle: UIAlertControllerStyleAlert];
    ...
    //删除
    cell.deleteSupplierRewardBlock = ^(){
