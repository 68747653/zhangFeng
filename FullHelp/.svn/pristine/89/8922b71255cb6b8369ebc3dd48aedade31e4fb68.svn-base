//
//  MerchantsRewardApplyViewController.m
//  FullHelp
//
...
#import "GlobalFile.h"
#import "MenuInfo.h"
#import "MerchantsRewardOngoingViewController.h"
#import "MerchantsRewardCompletedViewController.h"
#import "MerchantsRewardRefusedViewController.h"


@interface MerchantsRewardApplyViewController ()<UIScrollViewDelegate>
...
@implementation MerchantsRewardApplyViewController
...
-(void)setChildViewController{
    MerchantsRewardOngoingViewController *merchantsRewardOngoingViewController = [[MerchantsRewardOngoingViewController alloc] initWithMark:1 InfoID:_infoID];
    [self addChildViewController:merchantsRewardOngoingViewController];
    MerchantsRewardCompletedViewController *merchantsRewardCompletedViewController = [[MerchantsRewardCompletedViewController alloc] initWithMark:2 InfoID:_infoID];
    [self addChildViewController:merchantsRewardCompletedViewController];
    MerchantsRewardRefusedViewController *merchantsRewardRefusedViewController = [[MerchantsRewardRefusedViewController alloc] initWithMark:3 InfoID:_infoID];
    [self addChildViewController:merchantsRewardRefusedViewController];
}
