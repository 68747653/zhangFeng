...
@implementation RedPacketAdvertCell
...
-(instancetype)initWithNewAdvertStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier cellType:(CellType)cellType {
    self = [self initWithStyle:style reuseIdentifier:reuseIdentifier cellType:cellType];
    if (self) {
        _amountLabel = [[HHSoftLabel alloc] initWithFrame:CGRectZero fontSize:14 text:@"" textColor:[UIColor lightGrayColor] textAlignment:NSTextAlignmentLeft numberOfLines:1];
...
-(instancetype)initWithHomeAdvertStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier cellType:(CellType)cellType {
    self = [self initWithNewAdvertStyle:style reuseIdentifier:reuseIdentifier cellType:cellType];
    if (self) {
...
//        line.backgroundColor = [UIColor redColor].CGColor;
        ...
        _favorableLabel = [[HHSoftLabel alloc] initWithFrame:CGRectZero fontSize:12 text:@"" textColor:[HHSoftAppInfo defaultLightSystemColor] textAlignment:NSTextAlignmentLeft numberOfLines:1];
//        _favorableLabel.backgroundColor = [UIColor blueColor];
        [_bottomView addSubview:_favorableLabel];
      
        _countLabel = [[HHSoftLabel alloc] initWithFrame:CGRectZero fontSize:12 text:@"" textColor:[HHSoftAppInfo defaultDeepSystemColor] textAlignment:NSTextAlignmentRight numberOfLines:1];
...
//    self.backgroundColor = [GlobalFile backgroundColor];
    ...
    _imgLabel = [[HHSoftLabel alloc] initWithFrame:CGRectZero fontSize:14 text:@"" textColor:[UIColor whiteColor] textAlignment:NSTextAlignmentLeft numberOfLines:1];
...
//    _amountLabel = [[HHSoftLabel alloc] initWithFrame:CGRectZero fontSize:14 text:@"" textColor:[UIColor lightGrayColor] textAlignment:NSTextAlignmentLeft numberOfLines:1];
//    _amountLabel.backgroundColor = [UIColor brownColor];
//    [_bgView addSubview:_amountLabel];
//    
//    _favorableLabel = [[HHSoftLabel alloc] initWithFrame:CGRectZero fontSize:12 text:@"" textColor:[HHSoftAppInfo defaultLightSystemColor] textAlignment:NSTextAlignmentLeft numberOfLines:1];
//    _favorableLabel.backgroundColor = [UIColor blueColor];
//    [_bgView addSubview:_favorableLabel];
//    
//    _countLabel = [[HHSoftLabel alloc] initWithFrame:CGRectZero fontSize:12 text:@"" textColor:[HHSoftAppInfo defaultDeepSystemColor] textAlignment:NSTextAlignmentRight numberOfLines:1];
//    _countLabel.backgroundColor = [UIColor grayColor];
...
- (void) setAdvertInfo:(AdvertInfo *)advertInfo {
    ...
    _imgLabel.hidden = NO;
    if (self.cellType==CellTypeHotAdvert) {
        [_advertImg sd_setImageWithURL:[NSURL URLWithString:_advertInfo.advertImg] placeholderImage:[GlobalFile HHSoftDefaultImg2_1]];
        
        _imgLabel.text = [NSString stringWithFormat:@"  已打赏%@人,赏金%@元",_advertInfo.advertApplyCount,_advertInfo.advertAmount];
        
    }
    else if (self.cellType==CellTypeGrabAdvert) {
        [_advertImg sd_setImageWithURL:[NSURL URLWithString:_advertInfo.advertImg] placeholderImage:[GlobalFile HHSoftDefaultImg2_1]];
//        _merchantNameLabel.text = [NSString stringWithFormat:@"  %@",_advertInfo.merchantName];
        _imgLabel.text = [NSString stringWithFormat:@"  %@",_advertInfo.advertTitle];
    }
    else if (self.cellType==CellTypeNew) {
        [_advertImg sd_setImageWithURL:[NSURL URLWithString:_advertInfo.advertImg] placeholderImage:[GlobalFile HHSoftDefaultImg2_1]];
        _imgLabel.text = [NSString stringWithFormat:@"  %@",_advertInfo.advertTitle];
        _amountLabel.text = [NSString stringWithFormat:@"  已打赏%@人,赏金%@元",_advertInfo.advertApplyCount,_advertInfo.advertAmount];
    }
    else if (self.cellType==CellTypeHome2_1 || self.cellType==CellTypeHome1_1) {
        _imgLabel.hidden = YES;
        UIImage *placeholderImage;
        if (self.cellType==CellTypeHome2_1) {
            placeholderImage = [GlobalFile HHSoftDefaultImg2_1];
        }
        else if (self.cellType==CellTypeHome1_1) {
            placeholderImage = [GlobalFile HHSoftDefaultImg1_1];
        }
        [_advertImg sd_setImageWithURL:[NSURL URLWithString:_advertInfo.advertImg] placeholderImage:placeholderImage];
        _imgLabel.text = [NSString stringWithFormat:@"  %@",_advertInfo.advertTitle];
        _amountLabel.text = [NSString stringWithFormat:@"  已打赏%@人,赏金%@元",_advertInfo.advertApplyCount,_advertInfo.advertAmount];
        NSMutableAttributedString *tagAttributed = [[NSMutableAttributedString alloc] init];
        [tagAttributed attributedStringWithImageStr:@"tag.png" imageSize:CGSizeMake(17, 17)];
        [tagAttributed appendAttributedString:[[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"  %@",_advertInfo.advertTitle]]];
        ...
        [countAttributed attributedStringWithImageStr:@"like.png" imageSize:CGSizeMake(17, 17)];
        ...
        [countAttributed attributedStringWithImageStr:@"collect.png" imageSize:CGSizeMake(17, 17)];
...
- (void)layoutSubviews {
    ...
    if (self.cellType==CellTypeHome1_1) {
        height = width;
    }
