//
//  SupplierRewardCompletedViewController.m
//  FullHelp
//
...
@interface SupplierRewardCompletedViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SupplierRewardCompletedViewController
